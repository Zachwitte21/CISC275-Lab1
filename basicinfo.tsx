...
const yourName : String = "Zachary Witte";
let yourPronouns : String = "He/Him";
const yourMajor : String = "Computer Science";
let classification : String = "Sophomore";
let oneExcite : String = "Making projects in GitHub.";
let anyConcerns : String = "I am worried about getting lost in Git";
let funFact : String = "I enjoy playing Overwatch.";